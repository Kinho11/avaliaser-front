...
export const DashboardInstrutor = () => {
  ...
  return (
    <>
      ...
      <Typography  sx={{textAlign: "center", marginTop:"100px",fontWeight:"700",color:"#090f27"}} variant="h3">Dashboard Feedback</Typography>
              ...
              <TableBody>
                {data.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((data) => (
                  <StyledTableRow  key={data.codigo}>
                    ...
                    <StyledTableCell id="cargo" sx={{textAlign:"center"}}><Button id="botao-editar-admin"><EditIcon/></Button><Button><FactCheckIcon/></Button></StyledTableCell>
                  </StyledTableRow>
                ))}
              </TableBody>
            </Table>
